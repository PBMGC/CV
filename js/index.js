...
const infinito = () => {
  if (carrusel.scrollLeft === 0) {
    ...
    Math.ceil(carrusel.scrollLeft) ===
    carrusel.scrollWidth - carrusel.offsetWidth
  ) {
...
//portapapels
function copiar() {
  navigator.clipboard.writeText("dariogutierres456@gmail.com")
    .then(() => {
      window.alert("correo copiado en el portapapeles")
    })
    .catch((err) => {
        window.alert("error")    
    });
